...
export default function CaseStudies() {
  ...
  return (
    <section className="py-24 bg-slate-900 dark:bg-black text-white overflow-hidden relative">
      {/* Decorative blobs */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-purple/20 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex justify-between items-end mb-16">
          <div>
            ...
            <p className="text-slate-400 text-lg">{header.subtitle}</p>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="space-y-8">
                <div className="text-brand-lime font-bold tracking-wider uppercase text-sm">
                ...
                <button className="flex items-center gap-2 text-brand-lime font-bold hover:underline underline-offset-4 mt-4">
                  {cta.text} <ArrowUpRight className="w-4 h-4" />
                </button>
              </div>

              {/* Content Right (Visual) */}
              <div className={`w-full h-full rounded-3xl ${cases[currentIndex].image} relative overflow-hidden group`}>
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                   <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className="h-2 w-1/2 bg-slate-200/30 rounded"></div>
                      </div>
                   </div>
                </div>
              </div>
